...
import 'package:ashafaq/config/helpers/i_sqflite_helper.dart';
import 'package:ashafaq/core/constants/json_keys.dart';
import 'package:ashafaq/core/constants/sqflite_tables.dart';
...
''');
  ...
  @override
  Future<Map<String, dynamic>?> show(String tableName, {int? id}) async {
