...
import 'package:ashafaq/core/util/validators/email_validator.dart';
...
class UserDataValidator {
  ...
  void setFieldsValues({
    ...
    log('start set values: $firstName, $lastName, $phoneNumber, $email');
    firstNameController.text = firstName ?? this.firstName ?? '';
    lastNameController.text = lastName ?? this.lastName ?? '';
